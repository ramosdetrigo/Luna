...
var CARDS: Dictionary[Array, Array] = {
	["Lésbica.", "Lésbicas."]: [TextGradientMod.new(GRADIENTS["LESBIAN"])],
	["Trans.", "Direitos trans!"]: [TextGradientMod.new(GRADIENTS["TRANS"])],
	["LGTV.", "LGBT.", "Gays."]: [TextGradientMod.new(GRADIENTS["LGBT"])],
	["Homens gays."]: [TextGradientMod.new(GRADIENTS["GAY"])],
	["<A>"]: [BasicMod.new(TEXTURES["A"])],
	["<Abelhas>"]: [BasicMod.new(TEXTURES["abelhas"])],
	["<Bolsonaro>"]: [BasicMod.new(TEXTURES["bolsonaro"])],
	["<Brasil>"]: [BasicMod.new(TEXTURES["brasil"])],
	["<Bunda>"]: [BasicMod.new(TEXTURES["bunda"])],
	["<Carta preta>"]: [BasicMod.new(TEXTURES["black_front"], "Carta preta.", Color.WHITE)],
	["<Felps bombado>"]: [BasicMod.new(TEXTURES["felps_bombado"])],
	["<O tamanho dessa carta>"]: [BasicMod.new(TEXTURES["big"], "O tamanho dessa carta.")],
	["<Pau>"]: [BasicMod.new(TEXTURES["pau"])],
